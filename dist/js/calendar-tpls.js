angular.module("ui.rCalendar.tpls", ["template/rcalendar/bootstrap/day.html","template/rcalendar/bootstrap/month.html","template/rcalendar/bootstrap/week.html","template/rcalendar/calendar.html","template/rcalendar/mdl/day.html","template/rcalendar/mdl/month.html","template/rcalendar/mdl/week.html"]);
angular.module('ui.rCalendar', ['ui.rCalendar.tpls'])
    ...
    .directive('monthviewMdl', ['views', function (views) {
      'use strict';
      return {
          restrict: 'EA',
          replace: true,
          templateUrl: 'template/rcalendar/mdl/month.html',
          require: ['^calendar', '?^ngModel'],
          link: function (scope, element, attrs, ctrls) {

            views.month(scope, element, attrs, ctrls);

          }
        }
    }])
    .directive('monthviewBootstrap', ['views', function (views) {
        'use strict';
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'template/rcalendar/bootstrap/month.html',
            require: ['^calendar', '?^ngModel'],
            link: function (scope, element, attrs, ctrls) {
    ...
    .directive('weekviewMdl', ['views', function (views) {
      'use strict';
      return {
          restrict: 'EA',
          replace: true,
          templateUrl: 'template/rcalendar/mdl/week.html',
          require: '^calendar',
          link: function (scope, element, attrs, ctrl) {

            views.week(scope, element, attrs, ctrl);

          }
      };
    }])
    .directive('weekviewBootstrap', ['views', function (views) {
        'use strict';
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'template/rcalendar/bootstrap/week.html',
            require: '^calendar',
            link: function (scope, element, attrs, ctrl) {
    ...
    .directive('dayviewMdl', ['views', function (views) {
        'use strict';
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'template/rcalendar/mdl/day.html',
            require: '^calendar',
            link: function (scope, element, attrs, ctrl) {

              views.day(scope, element, attrs, ctrl);

            }
        };
    }])
    .directive('dayviewBootstrap', ['views', function (views) {
        'use strict';
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'template/rcalendar/bootstrap/day.html',
            require: '^calendar',
            link: function (scope, element, attrs, ctrl) {
    ...
    .factory('views', ['dateFilter', '$timeout', function(dateFilter, $timeout) {
      'use strict';

      return {

        month: function(scope, element, attrs, ctrls){
          var ctrl = ctrls[0],
              ngModelCtrl = ctrls[1];
        ...
        week: function(scope, element, attrs, ctrl){
        ...
        day: function(scope, element, attrs, ctrl){
...
angular.module("template/rcalendar/bootstrap/day.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/bootstrap/day.html",
    "<div>\n" +
...
angular.module("template/rcalendar/bootstrap/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/bootstrap/month.html",
    "<div>\n" +
...
angular.module("template/rcalendar/bootstrap/week.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/bootstrap/week.html",
    "<div>\n" +
...
angular.module("template/rcalendar/calendar.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/calendar.html",
    ...
    "  <div ng-if=\"template == 'mdl'\">\n" +
    "    <div class=\"mdl-grid calendar-navbar\">\n" +
    "      <div class=\"nav-left mdl-cell mdl-cell--2-col\">\n" +
    "        <button type=\"button\" class=\"mdl-button mdl-js-button\" ng-click=\"move(-1)\">\n" +
    "          <i class=\"material-icons\">arrow_back</i>\n" +
    "        </button>\n" +
    "      </div>\n" +
    "      <div class=\"calendar-header mdl-cell mdl-cell--8-col\">{{title}}</div>\n" +
    "      <div class=\"nav-right mdl-cell mdl-cell--2-col\">\n" +
    "        <button type=\"button\" class=\"mdl-button mdl-js-button\" ng-click=\"move(1)\">\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <monthview-mdl ng-switch-when=\"month\"></monthview-mdl>\n" +
    "    <dayview-mdl ng-switch-when=\"day\"></dayview-mdl>\n" +
    "    <weekview-mdl ng-switch-when=\"week\"></weekview-mdl>\n" +
    "  </div>\n" +
    "  <div ng-if=\"template == 'bootstrap'\">\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <dayview-bootstrap ng-switch-when=\"day\"></dayview-bootstrap>\n" +
    "    <monthview-bootstrap ng-switch-when=\"month\"></monthview-bootstrap>\n" +
    "    <weekview-bootstrap ng-switch-when=\"week\"></weekview-bootstrap>\n" +
    "  </div>\n" +
    "</div>\n" +
    "");
}]);

angular.module("template/rcalendar/mdl/day.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/mdl/day.html",
    "<div>\n" +
    "    <div class=\"dayview-allday-table\">\n" +
    "        <div class=\"dayview-allday-label\">\n" +
    "            all day\n" +
    "        </div>\n" +
    "        <div class=\"dayview-allday-content-wrapper\">\n" +
    "            <table class=\"mdl-data-table mdl-js-data-table dayview-allday-content-table full-table\">\n" +
    "                <tbody>\n" +
    "                <tr>\n" +
    "                    <td class=\"calendar-cell\" ng-class=\"{'calendar-event-wrap':allDayEvents}\"\n" +
    "                        ng-style=\"{height: 25*allDayEvents.length+'px'}\">\n" +
    ...
    "    </div>\n" +
    "    <div class=\"scrollable\" style=\"height: 400px\">\n" +
    "        <table class=\"mdl-data-table mdl-js-data-table table-fixed full-table\">\n" +
    "            <tbody>\n" +
    "            <tr ng-repeat=\"tm in rows track by $index\">\n" +
    "                <td class=\"calendar-hour-column mdl-typography--text-center\">\n" +
    "                    {{tm.time | date: formatHourColumn}}\n" +
    "                </td>\n" +
    "                <td class=\"calendar-cell\" ng-click=\"select(tm.time)\">\n" +
    "                    <div ng-class=\"{'calendar-event-wrap': tm.events}\" ng-if=\"tm.events\">\n" +
...
angular.module("template/rcalendar/mdl/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/mdl/month.html",
    "<div>\n" +
    "    <table class=\"mdl-data-table mdl-js-data-table mdl-shadow--2dp table-fixed monthview-datetable full-table\">\n" +
    "        <thead>\n" +
    "        <tr>\n" +
    "            <th ng-show=\"showWeeks\" class=\"calendar-week-column mdl-typography--text-center\">#</th>\n" +
    "            <th ng-repeat=\"label in labels track by $index\" class=\"mdl-typography--text-center\">\n" +
    "                <small>{{label}}</small>\n" +
    "            </th>\n" +
    "        </tr>\n" +
    "        </thead>\n" +
    "        <tbody>\n" +
    "        <tr ng-repeat=\"row in rows track by $index\">\n" +
    "            <td ng-show=\"showWeeks\" class=\"calendar-week-column mdl-typography--text-center\">\n" +
    "                <small><em>{{ weekNumbers[$index] }}</em></small>\n" +
    "            </td>\n" +
    "            <td ng-repeat=\"dt in row track by dt.date\" class=\"monthview-dateCell\" ng-click=\"select(dt.date)\"\n" +
    ...
    "                <div ng-class=\"{'mdl-typography--text-center': true, 'text-muted':dt.secondary}\">\n" +
    "                    {{dt.label}}\n" +
    "                </div>\n" +
    "            </td>\n" +
    "        </tr>\n" +
    ...
    "            <li ng-if=\"!selectedDate.events\">\n" +
    "              <span class=\"no-event-label\">No Events</span>\n" +
    "            </li>\n" +
    "            <li class=\"mdl-list__item mdl-list__item--two-line\" ng-repeat=\"event in selectedDate.events\" ng-if=\"selectedDate.events\"  ng-click=\"eventSelected({event:event})\">\n" +
    "              <span class=\"mdl-list__item-primary-content\" class=\"monthview-eventdetail\">\n" +
    "                <span>\n" +
    "                  {{event.title}}\n" +
    "                </span>\n" +
    "                <span class=\"mdl-list__item-sub-title\" ng-if=\"!event.allDay\">\n" +
...
angular.module("template/rcalendar/mdl/week.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/mdl/week.html",
    "<div>\n" +
    "    <table class=\"mdl-data-table mdl-js-data-table table-fixed weekview-header full-table\">\n" +
    "        <thead>\n" +
    "        <tr>\n" +
    "            <th class=\"calendar-hour-column\"></th>\n" +
    "            <th ng-repeat=\"dt in dates\" class=\"mdl-typography--text-center weekview-header-label\">{{dt.date| date:\n" +
    "                formatWeekViewDayHeader}}\n" +
    "            </th>\n" +
    "            <th ng-if=\"gutterWidth>0\" class=\"gutter-column\" ng-style=\"{width: gutterWidth+'px'}\"></th>\n" +
    "        </tr>\n" +
    ...
    "        </div>\n" +
    "        <div class=\"weekview-allday-content-wrapper\">\n" +
    "            <table class=\"mdl-data-table mdl-js-data-table table-fixed weekview-allday-content-table full-table\">\n" +
    "                <tbody>\n" +
    "                <tr>\n" +
    "                    <td ng-repeat=\"day in dates track by day.date\" class=\"calendar-cell\">\n" +
    "                        <div ng-class=\"{'calendar-event-wrap': day.events}\" ng-if=\"day.events\"\n" +
    ...
    "    </div>\n" +
    "    <div class=\"scrollable\" style=\"height: 400px\">\n" +
    "        <table class=\"mdl-data-table mdl-js-data-table mdl-shadow--2dp table-fixed full-table  table-bordered\">\n" +
    "            <tbody>\n" +
    "            <tr ng-repeat=\"row in rows track by $index\">\n" +
    "                <td class=\"calendar-hour-column mdl-typography--text-center\">\n" +
    "                    {{row[0].time | date: formatHourColumn}}\n" +
